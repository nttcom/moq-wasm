...
export function createEmptyEditableCatalogTrack(role: CatalogTrackRole): EditableMeetingCatalogTrack {
  if (role === 'chat') {
...
export function createEmptyEditableScreenShareCatalogTrack(): EditableMeetingCatalogTrack {
  return {
    id: createCatalogTrackId(),
