...
impl MOQTPayload for SubscribeAnnouncesError {
    fn depacketize(buf: &mut bytes::BytesMut) -> Result<Self> {
        ...
        tracing::trace!("Depacketized subscribe announces error message.");
    ...
    fn packetize(&self, buf: &mut bytes::BytesMut) {
        ...
        tracing::trace!("Packetized subscribe announces error message.");
    }
...
mod success {
    use crate::messages::moqt_payload::MOQTPayload;
    use crate::modules::messages::control_messages::subscribe_announces_error::SubscribeAnnouncesError;
    use bytes::BytesMut;
