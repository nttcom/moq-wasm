...
mod decoder {
    ...
    use crate::modules::session_handlers::messages::variable_integer::read_variable_integer;
...
mod encoder {
    ...
    use crate::modules::session_handlers::messages::variable_integer::write_variable_integer;
