...
use crate::{
    ...
    modules::session_handlers::messages::variable_bytes::{read_all_variable_bytes, read_bytes},
...
mod tests {
    ...
    mod failure {
        ...
        use crate::modules::session_handlers::messages::data_streams::{DataStreams, datagram};
