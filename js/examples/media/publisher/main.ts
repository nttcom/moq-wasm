...
//   let { objectId, groupId, subgroupId, isSendedSubgroupHeader } = MediaTrackInfo['audio']
...
//   sendAudioObjectMessage(trackAlias, groupId, subgroupId, objectId++, chunk, metadata, client)
// }
