...
/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --test-type --origin-to-force-quic-on=127.0.0.1:4433 --ignore-certificate-errors-spki-list=$certbase64 --use-fake-device-for-media-stream
