...
/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --test-type --origin-to-force-quic-on=172.16.19.130:4433,127.0.0.1:4433,10.0.254.183:4433,192.168.11.17:4433 --ignore-certificate-errors-spki-list=$certbase64 --use-fake-device-for-media-stream
