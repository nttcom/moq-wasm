...
- js/utils/media/encoders/videoEncoder.tsについてmasterブランチに対してbuildDefaultConfigが変更されているのでデフォルト値は元に戻しつつ、playwrightのテスト時にはvp8/prefer-softwareで正常にlinux上のchromiumでテストが動作する設定を使うように実装を変更してください
- You
- js/utils/media/encoders/videoEncoder.tsについてmasterブランチに対してbuildDefaultConfigが変更されているのでデフォルト値は元に戻しつつ、playwrightのテスト時にはvp8/prefer-softwareで正常にlinux上のchromiumでテストが動作する設定を使うように実装を変更してください
